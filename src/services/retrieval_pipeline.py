...
from src.services.retrieval_metrics import RetrievalMetrics, StageTimer
...
class RetrievalPipeline:
    ...
    def __init__(self) -> None:
        ...
        from src.services.reranking_service import get_reranker
        from src.services.query_enhancer import get_query_enhancer
        ...
        if settings.HYBRID_SEARCH_ENABLED:
            try:
                from src.services.sparse_embedding_service import embed_sparse_query
