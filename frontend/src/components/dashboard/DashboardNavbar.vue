      ...
      <div class="relative">
        ...
        <Transition name="fade">
          <div v-if="isProfileOpen" class="absolute right-0 top-10 w-48 bg-[#1c1c1c] border border-white/[0.08] rounded-xl shadow-2xl z-50 overflow-hidden">
            ...
            <div class="py-1">
              <button @click="router.push('/events?admin=settings'); isProfileOpen = false" class="w-full text-left px-3 py-2 text-[13px] text-[#ececec] hover:bg-white/5 transition-colors flex items-center gap-2">
