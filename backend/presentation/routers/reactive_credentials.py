...
from backend.presentation.schemas.credential import CredentialCreate, CredentialOut
from backend.core.deps import get_db, get_current_user
from backend.domain.models.user import User
from backend.application.credentials.service import CredentialService
