...
from backend.application.data_analysis.connector_schemas import SchemaDiscoveryResult, SchemaTable, SchemaColumn
from backend.infrastructure.vector.schema_vector_repository import SchemaVectorRepository
from backend.infrastructure.embeddings.dense import embed_texts, embed_query
from backend.infrastructure.embeddings.sparse import embed_sparse_texts, embed_sparse_query
