...
from backend.presentation.schemas.event import EventIngestPayload
...
from backend.infrastructure.persistence.webhook_source_repository import WebhookSourceRepository
from backend.application.events.mapping import WebhookMappingEngine
from backend.application.events.service import EventService
...
class WebhookService:
    ...
    async def receive(
        ...
        if not webhook_domain:
            ...
            from backend.application.domain_config.detector import DomainDetector
