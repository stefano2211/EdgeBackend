...
from backend.ia.factory import create_reactive_orchestrator
from backend.ia.schemas.reactive import ReactiveAnalysisOutput
from backend.domain.models.event import Event
from backend.application.events.broadcast import EventBroadcastManager
...
class ReactiveOrchestrator:
    ...
    async def _run_analyst(
        ...
        try:
            ...
            from backend.infrastructure.llm.langchain import get_chat_model
    ...
    async def _resolve_db_connection_ids(
        ...
        if user_id is None:
            return []
        try:
            from backend.application.data_analysis.connector_repository import DatabaseConnectionRepository
    ...
    async def _send_analysis_result(
        ...
        try:
            ...
            from backend.domain.models.integration_instance import IntegrationInstance
            from backend.application.integrations.service import IntegrationService
            from backend.application.integrations.mcp.service import MCPService
