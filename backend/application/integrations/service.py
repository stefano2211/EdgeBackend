...
from backend.application.integrations.strategies import get_strategy
from backend.application.integrations.credentials import CredentialManager
from backend.application.integrations.vault import CredentialVault
from backend.domain.ports.integration_ports import ICredentialVault
...
from backend.application.integrations.catalog import CatalogService
from backend.presentation.schemas.integration import (
    CredentialsSubmit,
    IntegrationInstanceCreate,
    IntegrationInstanceUpdate,
)
from backend.application.integrations.audit import log_credential_event, CredentialAction
...
class IntegrationService:
    ...
    async def complete_oauth(
        ...
        from backend.application.integrations.gmail_flow import exchange_code
